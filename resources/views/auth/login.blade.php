...
<html lang="en-US" class="scroll-smooth bg-slate-950">
  <head>
    ...
    <meta name="description" content="Login to {{ env('APP_NAME') }} to save, manage, and organize your favorite high-quality wallpapers." />
    <meta name="robots" content="noindex, nofollow" />
    <link rel="canonical" href="{{ route('login') }}" />

    <meta property="og:title" content="Login | {{ env('APP_NAME') }}" />
    <meta property="og:description" content="Login to {{ env('APP_NAME') }} to save, manage, and organize your favorite high-quality wallpapers." />
